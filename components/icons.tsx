export function IconCart({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      />
      <circle cx="9.5" cy="20.5" r="1.25" fill="currentColor" stroke="none" />
      <circle cx="17" cy="20.5" r="1.25" fill="currentColor" stroke="none" />
    </svg>
  );
}
...
export function IconAccount({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M4.5 19.5c1.5-3.5 4.5-5 7.5-5s6 1.5 7.5 5" strokeLinecap="round" />
    </svg>
  );
}
